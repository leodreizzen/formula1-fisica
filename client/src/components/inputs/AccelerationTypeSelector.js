    ...
    return (
        <div className="flex flex-row w-full">
            <div>
                ...
                />
                <label className="radio-label text-lg text-gray-900 dark:text-gray-300">Modulo</label>
            </div>
            <div>
                <input
                    type="radio"
                ...
                />
                <label className="radio-label text-lg text-gray-900 dark:text-gray-300">Tangencial</label>
            </div>
            <div>
                <input
                    type="radio"
                    ...
                    className="mr-2 ml-3 w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                />
                <label className="radio-label text-lg text-gray-900 dark:text-gray-300">Normal</label>
            </div>
